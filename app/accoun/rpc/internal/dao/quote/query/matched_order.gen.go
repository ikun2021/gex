...
import (
	...
	"github.com/ikun2021/gex/app/accoun/rpc/internal/dao/quote/model"
)
...
func (m matchedOrderDo) GetByID(id int) (result model.MatchedOrder, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, id)
	generateSQL.WriteString("SELECT * FROM matched_order WHERE id = ? ")
