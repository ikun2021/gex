...
type CreateOrderReq struct {
	...
	BaseAmount  string `json:"base_amount" validate:"required,numeric"` //数量
	QuoteAmount string `json:"quote_amount"`                            //金额
...
type OrderInfo struct {
	...
	BaseAmount        string `json:"base_amount"`         //数量
	QuoteAmount       string `json:"quote_amount"`        //金额
	Side              int32  `json:"side"`                //方向
	Status            int32  `json:"status"`              // 状态
	OrderType         int32  `json:"order_type"`          //订单类型
	FilledBaseAmount  string `json:"filled_base_amount"`  //成交数量
	FilledQuoteAmount string `json:"filled_quote_amount"` //成交金额
